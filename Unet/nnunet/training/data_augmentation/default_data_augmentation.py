...
def get_default_augmentation(dataloader_train, dataloader_trainRAW, dataloader_val, patch_size, params=default_3D_augmentation_params, border_val_seg=-1, pin_memory=True,
    ...
    batchgenerator_trainRAW = MultiThreadedAugmenter(dataloader_trainRAW, val_transforms, params.get('num_threads'), params.get("num_cached_per_thread"), seeds=seeds_train, pin_memory=pin_memory)

    return batchgenerator_train, batchgenerator_trainRAW, batchgenerator_val
