...
if __name__ == "__main__":
    train_dir = "/vol/medic02/users/zl9518/KiTS19/kits19/nnunet_output/imagesTr"
    test_dir = "/vol/medic02/users/zl9518/KiTS19/kits19/nnunet_output/labelsTr"


    output_folder = "/vol/medic02/users/zl9518/KiTS19/kits19/nnunet_output"
    ...
    nii_files_tr_data = subfiles(train_dir, True, "0", "nii.gz", True)
    nii_files_tr_seg = subfiles(train_dir, True, "0", "nii.gz", True)
    ...
    train_ids = list(range(0, 210))
    test_ids = list(range(0, 0))
    ...
    json_dict['training'] = [{'image': "./imagesTr/%.4d.nii.gz" % i, "label": "./labelsTr/%.4d.nii.gz" % i} for i in train_ids]
