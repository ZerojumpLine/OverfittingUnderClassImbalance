    ...
    for batch_i in range(num_batches):
        ...
        if train_or_val=="train" :
            ...
            if n_epsilon > 0:
                ...
                # adding some perturbations would make it easy to find the gradient.
            ...
            ####################### the second step, trainining using the normal samples #######################
            '''
            ...
            ####################### the third step, trainining using the adversarial training argumented results #######################
            '''
            ...
            ####################### the forth step, trainining using the mixup samples #######################
            '''
            ...
            if mixup_rate > 0 :
                ...
                mixup_lambda = np.random.beta(mixup_rate, mixup_rate) * (1 - mixup_biasmargin * (mixup_biasmargin > 0))
