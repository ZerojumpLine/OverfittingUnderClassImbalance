...
class SoftmaxLayer(TargetLayer):
    ...
    def get_output_gt_tensor_feed(self):
        ...
        y_gt_train0 = tf.placeholder(dtype="int32", shape=[None, None, None, None], name="y_train0")
        y_gt_train1 = tf.placeholder(dtype="int32", shape=[None, None, None, None], name="y_train1")
        mixup_lambda = tf.placeholder(dtype="float32", shape=None, name="mixup_lambda")
        y_gt_val = tf.placeholder(dtype="int32", shape=[None, None, None, None], name="y_val")
        return (y_gt_train0, y_gt_train1, mixup_lambda, y_gt_val)
