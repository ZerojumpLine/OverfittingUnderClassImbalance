...
class Trainer(object):
    ...
    def __init__(   self,
        ...
        self._mixup_biasmargin = mixup_biasmargin
        self._marginm = marginm
        # Costs
    ...
    def _setup_costs(self, log):
        ...
        # Cost functions
        cost = 0
        y_gtmix0 = self._net._output_gt_tensor_feeds['train']['y_gt0']
        ...
        if "focaloneside" in self._losses_and_weights and self._losses_and_weights["focaloneside"] is not None:
            ...
            cost += self._losses_and_weights["focaloneside"] * cfs.focaloneside(self._net.finalTargetLayer.network_output, y_gtmix0, y_gtmix1, self._losses_and_weights["focalonesidegama"], w_per_cl_vec, self._mixup_biasmargin, self._marginm, mixup_lambda)
